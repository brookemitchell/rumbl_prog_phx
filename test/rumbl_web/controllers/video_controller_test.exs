defmodule RumblWeb.VideoControllerTest do
  ...
  describe "with a logged in user" do
    ...
    @tag login_as: "max"
    test "does not create vid, creates errors when invalid", %{conn: conn} do
  ...
  test "authorizes actions against acess by other users", %{conn: conn} do
    ...
    assert_error_sent :not_found, fn -> get(conn, Routes.video_path(conn, :delete, video)) end
  end
end
